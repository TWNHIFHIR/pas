...
Description: "臺灣衛生福利部中央健康保險署「Standard SOP Classes」代碼，代碼出版日期：2026-09-01；資料所屬單位：臺灣衛生福利部中央健康保險署。參照自DICOM網站(https://dicom.nema.org/medical/dicom/current/output/chtml/part04/sect_B.5.html)中的「Table B.5-1. Standard SOP Classes」"
* ^caseSensitive = true
* ^content = #complete
* ^date = "2026-09-01"
* ^version = "2026-09-01"
