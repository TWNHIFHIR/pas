...
* . obeys sequence-1 and applType and supportingInfo and supportingInfo-tests and supportingInfo-tests-2
...
Invariant:   supportingInfo-tests-2
Description: "當Claim.diagnosis.diagnosisCodeableConcept(國際疾病分類代碼)為C90或C92，需提供檢驗(查)。"
Expression:  "(diagnosis.diagnosis.ofType(CodeableConcept).coding.where(code.matches('^(C90|C92)')).exists()) implies (supportingInfo.category.exists(coding.code = 'tests'))"
Severity:    #error
