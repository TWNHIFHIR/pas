...
* item.adjudication.category.system ^example[0].valueUri = "http://terminology.hl7.org/CodeSystem/adjudication"
* item.adjudication.category.value ^example[0].valueString = "submitted"
* item.adjudication.value ^short = "核定數量。"
* item.adjudication.reason ^short = "受理審查案件核定。1:同意 | 2:不予同意 | 3:部份同意 | 4:補件 | 5:退件"
...
* item.detail.adjudication.category.system ^example[0].valueUri = "http://terminology.hl7.org/CodeSystem/adjudication"
* item.detail.adjudication.category.value ^example[0].valueString = "submitted"
* disposition 1..
