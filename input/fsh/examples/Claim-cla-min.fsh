...
* priority = https://twcore.mohw.gov.tw/ig/pas/CodeSystem/nhi-tmhb-type#1 "一般事前審查申請"
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
    ...
    <blockquote>
        <p><b>supportingInfo</b></p>
        <p><b>sequence</b>：8</p>
        <p><b>category</b>：<span title=\"Codes:{https://twcore.mohw.gov.tw/ig/pas/CodeSystem/nhi-supporting-info-type tests}\">檢驗檢查-單項</span></p>
        <p><b>value</b>：<a href=\"Observation-obs-lab-min.html\">Observation/obs-lab-min</a></p>
    </blockquote>
    <blockquote>
        <p><b>supportingInfo</b></p>
        <p><b>sequence</b>：9</p>
        <p><b>category</b>：<span title=\"Codes:{https://twcore.mohw.gov.tw/ig/pas/CodeSystem/nhi-supporting-info-type tests}\">檢驗檢查-套組(全套血液檢查)</span></p>
...
* status = http://hl7.org/fhir/fm-status#active
* type = http://terminology.hl7.org/CodeSystem/claim-type#institutional
* subType = https://twcore.mohw.gov.tw/ig/pas/CodeSystem/nhi-apply-type#3 "申復"
* use = http://hl7.org/fhir/claim-use#preauthorization
* patient.reference = "Patient/pat-min"
* created = "2024-05-30"
* enterer.reference = "Practitioner/pra-min"
