...
* diagnosis.diagnosisCodeableConcept  = https://twcore.mohw.gov.tw/ig/twcore/CodeSystem/icd-10-cm-2023-tw#C18.1
...
* item[=].modifier[continuation] = https://nhicore.nhi.gov.tw/pas/CodeSystem/nhi-continuation-status#2 "申請再次使用"
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
    ...
    <p><b>國際疾病分類代碼</b>：闌尾惡性腫瘤<span style=\"background: LightGoldenRodYellow; margin: 4px; border: 1px solid khaki\"> (<a href=\"https://twcore.mohw.gov.tw/ig/twcore/CodeSystem/icd-10-cm-2023-tw\">臺灣健保署2023年中文版ICD-10-CM值集</a>#C18.1)</span></p>
...
Instance: inline-2-claRes-self-assessment
...
Instance: inline-2-practitioner
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
  ...
  <p>
    ...
    <b>機構代碼（official）</b>：0101090517 (https://nhicore.nhi.gov.tw/pas/CodeSystem/organization-identifier-tw)
  </p>
  <p>
...
Instance: inline-2-diaRep-ima-2
InstanceOf: DiagnosticReportImageTWPAS
Usage: #inline
* status = http://hl7.org/fhir/diagnostic-report-status#final
* category = NHIPASSupportingInfoType#imagingReport
...
Instance: inline-2-diaRep-ima-loinc
InstanceOf: DiagnosticReportImageTWPAS
...
Instance: inline-2-doc-careplan
InstanceOf: DocumentReferenceTWPAS
Usage: #inline
...
Instance: inline-2-medReq-apply
InstanceOf: MedicationRequestApplyTWPAS
Usage: #inline
* status = http://hl7.org/fhir/CodeSystem/medicationrequest-status#on-hold
* intent = #plan
* medicationCodeableConcept = https://nhicore.nhi.gov.tw/pas/CodeSystem/nhi-medication#BC27730100
* subject.reference = "urn:uuid:047422b2-0c18-4707-801d-465833e6d65d"
...
* dosageInstruction[=].timing.code[=].coding[+] = https://nhicore.nhi.gov.tw/pas/CodeSystem/medication-frequency-nhi-tw#AC1H
...
* dosageInstruction[=].timing.code[0].coding[0] = https://nhicore.nhi.gov.tw/pas/CodeSystem/medication-frequency-nhi-tw#Q4WD1
* dosageInstruction[=].timing.code[=].coding[+] = https://nhicore.nhi.gov.tw/pas/CodeSystem/medication-frequency-nhi-tw#Q4WD2
* dosageInstruction[=].timing.code[=].coding[+] = https://nhicore.nhi.gov.tw/pas/CodeSystem/medication-frequency-nhi-tw#Q4WD3
* dosageInstruction[=].timing.code[=].coding[+] = https://nhicore.nhi.gov.tw/pas/CodeSystem/medication-frequency-nhi-tw#Q4WD4
* dosageInstruction[=].timing.code[=].coding[+] = https://nhicore.nhi.gov.tw/pas/CodeSystem/medication-frequency-nhi-tw#Q4WD5
* dosageInstruction[=].timing.code[=].coding[+] = https://nhicore.nhi.gov.tw/pas/CodeSystem/medication-frequency-nhi-tw#AC1H
...
//* category[orderType] = https://nhicore.nhi.gov.tw/pas/CodeSystem/nhi-order-type#4 "癌症用藥"
* text.status = #generated
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
    <div style=\"display: inline-2-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\">
...
Instance: inline-2-medReq-apply-2
InstanceOf: MedicationRequestApplyTWPAS
Usage: #inline
* status = http://hl7.org/fhir/CodeSystem/medicationrequest-status#on-hold
* intent = #plan
* medicationCodeableConcept = https://nhicore.nhi.gov.tw/pas/CodeSystem/nhi-medication#KC009612B5
* subject.reference = "urn:uuid:047422b2-0c18-4707-801d-465833e6d65d"
...
Instance: inline-2-medReq-treat
...
Instance: inline-2-obs-cancer-figo
...
Instance: inline-2-obs-diagnostic
...
Instance: inline-2-obs-tx
InstanceOf: ObservationTreatmentAssessmentTWPAS
Usage: #inline
* status = http://hl7.org/fhir/observation-status#final
* code.coding = https://nhicore.nhi.gov.tw/pas/CodeSystem/nhi-tx-ast#IWGC "International Working Group(IWG) Consensus Criteria"
* effectiveDateTime = "2024-05-07"
* performer.reference = "urn:uuid:1cf37d4c-1fd2-43c5-8b4e-277c0fef5020"
* subject.reference = "urn:uuid:047422b2-0c18-4707-801d-465833e6d65d"
...
* ingredient.substanceCodeableConcept = https://twcore.mohw.gov.tw/ig/twcore/CodeSystem/icd-10-pcs-2023-tw#D0000ZZ
* text.status = #generated
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
    <div style=\"display: inline-2-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4;
        border-radius: 5px; line-height: 60%\">
...
Instance: inline-2-doc-medicalRecord
InstanceOf: DocumentReferenceTWPAS
Title: "病歷資料"
