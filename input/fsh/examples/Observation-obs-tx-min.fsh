...
Usage: #example
* status = http://hl7.org/fhir/observation-status#final
* code.coding = https://nhicore.nhi.gov.tw/pas/CodeSystem/nhi-tx-ast#IREC
* effectiveDateTime = "2024-05-07"
* performer.reference = "Practitioner/pra-min"
* subject.reference = "Patient/pat-min"
* valueString = "iUPD"
...
Usage: #example
* status = http://hl7.org/fhir/observation-status#final
* code.coding = https://nhicore.nhi.gov.tw/pas/CodeSystem/nhi-tx-ast#ICLL
* effectiveDateTime = "2024-05-07"
* performer.reference = "Practitioner/pra-min"
* subject.reference = "Patient/pat-min"
* valueString = "SD"
...
Usage: #example
* status = http://hl7.org/fhir/observation-status#final
* code.coding = https://nhicore.nhi.gov.tw/pas/CodeSystem/nhi-tx-ast#MREC
* effectiveDateTime = "2024-05-07"
* performer.reference = "Practitioner/pra-min"
* subject.reference = "Patient/pat-min"
* valueString = "PDD"
...
Usage: #example
* status = http://hl7.org/fhir/observation-status#final
* code.coding = https://nhicore.nhi.gov.tw/pas/CodeSystem/nhi-tx-ast#REC1
* effectiveDateTime = "2024-05-07"
* performer.reference = "Practitioner/pra-min"
* subject.reference = "Patient/pat-min"
...
Usage: #example
* status = http://hl7.org/fhir/observation-status#final
* code.coding = https://nhicore.nhi.gov.tw/pas/CodeSystem/nhi-tx-ast#IWGC
* effectiveDateTime = "2024-05-07"
* performer.reference = "Practitioner/pra-min"
* subject.reference = "Patient/pat-min"
