### 免疫製劑事前審查之Bundle架構(Bundle Immunologic Aagent Applying)
<div  style="padding-left: 10px;"> 
免疫製劑事前審查申請透過Bundle打包以下資料(相關對應表可以參照申請(Apply)免疫製劑(Immunologic Aagent)事前審查之資料模型中的<a href="StructureDefinition-ApplyImmModel-mappings.html">Mappings</a>)：
<ul>
	<li>免疫製劑事前審查-Claim Immunologic Aagent TWPAS</li>
	<li>門診病歷-Encounter OPD TWPAS</li>
	<li>就醫科別-Encounter TWPAS</li>
	<li>病人資訊-Patient TWPAS</li>
	<li>醫事人員-Practitioner TWPAS</li>
	<li>醫事機構-Organization TWPAS</li>
	<li>診斷-Condition TWPAS</li>
	<li>血型-Observation Blood Group TWPAS</li>
	<li>過敏史-AllergyIntolerance TWPAS</li>
	<li>主觀描述-Observation Subjective TWPAS</li>
	<li>客觀描述-Observation Objective TWPAS</li>
	<li>評估-ClinicalImpression TWPAS</li>
	<li>計畫-CarePlan TWPAS</li>
	...
	<li>照光治療-Procedure Phototherapy TWPAS</li>
	<li>照光治療總次數-Substance Phototherapy TWPAS</li>
...
#### Bundle架構圖
<div  style="padding-left: 10px;"> 
<img class="figure-img img-responsive img-rounded center-block" src="apply-imm.png" alt="Bundle Immunologic Aagent Apply架構圖" style="display: block;margin-left: auto;margin-right: auto;width: 80%;"/>
</div>

<br>

### 免疫製劑事前審查回覆之Bundle架構(Bundle Response)
<div  style="padding-left: 10px;"> 
透過查詢參數搜尋免疫製劑事前審查狀態時，若操作語法有誤且執行失敗，將透過<a href="StructureDefinition-Operationoutcome-twpas.html">系統回應訊息-OperationOutcome TWPAS</a>回應錯誤訊息；  
