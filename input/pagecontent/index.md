...
<p><b>請注意</b>：您目前所看到的IG為持續建置(ci-build)版，主要依據實作者及健保署端的業務需求即時調整V1.2.2版內容，因而會比健保署的IG版本V1.2.2(https://nhicore.nhi.gov.tw/pas/)內容新，僅供未來想以最新版本規格進行資料上傳的人員參考，下次更新版本號時間預計為115年6月，屆時才會調整相應版本的健保署FHIR伺服器規格。<br/>
<br/>
