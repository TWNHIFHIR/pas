...
<p><b>請注意</b>：您目前所看到的IG為持續建置(ci-build)版，主要依據實作者及健保署端的業務需求即時調整V1.0.3版內容，因而會比衛生福利部的IG版本V1.0.3(https://fhir-ig.nhi.org.tw/pas/)內容新，僅供未來想以最新版本規格進行資料上傳的人員參考，下次更新版本號時間預計為114年6月2日，屆時才會調整相應版本的健保署FHIR伺服器規格。<br/>
<br/>
