...
因考量實作需求，於2025/10/15異動以下內容：
    <ol>  
        ...
        <li>修改<a href="StructureDefinition-Claim-twpas.html">Profile: 事前審查-Claim TWPAS</a>：修改Constraints: supportingInfo：至少還需提供檢查報告、影像報告、基因資訊中任一樣資訊。</li>
