...
<p>在packages路徑下創建一個資料夾並命名為「tw.gov.mohw.nhi.pas#1.2.2」，將package.tgz解壓縮後的package資料夾放置於「tw.gov.mohw.nhi.pas#1.2.2」中。</p>
...
　3. 驗證的IG及其版本號－<b style="color: #E78E46;">橘色③</b>『<code>-ig tw.gov.mohw.nhi.pas#1.2.2</code>』，鍵入Enter，即可查看驗證結果<br />
　<b style="color: red;">①</b>、<b style="color: #4D82B8;">②</b>、<b style="color: #E78E46;">③</b>之間需有空格，完整語法即：<code>java -jar validator_cli.jar Bundle-bun-1.json -ig tw.gov.mohw.nhi.pas#1.2.2</code></p>
